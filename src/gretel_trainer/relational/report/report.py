...
class Report:
    ...
    def __init__(self,
        ...
        #self.model = multitable._model_config
        #self.strategy = multitable._strategy
        self.dir = multitable._working_dir
        #self.report_html = self.render()
    ...
    def create_fields_dict(self):
        ...
        for table in self.rel_data:
            ...
            if pkey is not None:
                ...
                columns.append(
                    Cell(value=pkey, color=colors_dict[table], bold='bold'))
            ...
            if len(fkeys) > 0:
                for key in fkeys:
                    ...
                    columns.append(Cell(value=key.column_name,
